...
Наверняка у вас есть свой  Minecraft SMP на сервисе Aternos, для того, чтобы просто чиллово посидеть и поиграть с друзьями(если они есть). Доступ к серверу есть только у вас и у вашего друга. И в Discord, вы каждый день видите такие сообщения у себя в личных сообщениях:

"Включите сервер"

Раздражает, не так ли?
А если это происходит каждый день?
А если вы заняты? :)

Ладно, ладно, всё, успокоились. У меня есть решение этой проблемы!
...
I’m sure you have your own Minecraft SMP server on Aternos, just so you can chill out and play with friends (if you have any). Only you and your friend have access to the server. And on Discord, you see messages like this in your private messages every day:
...
Okay, okay, calm down. I have a solution to this problem!

It’s a bot that can start the server through your account with a direct command from your chat with friends! Just type /start and you can play.

And you might ask, wouldn’t it be easier if all your friends signed up for Aternos? No, it wouldn’t be easier. After all, they’d have to go to the website, click a button, catch the moment when the server can be started… and so on. Well, if someone wants to mess with the server, they won’t be able to :). Your SMP is safe.
